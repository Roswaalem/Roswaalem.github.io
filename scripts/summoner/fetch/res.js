document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            document.getElementById("champion1_icon").src = "https://ddragon.leagueoflegends.com/cdn/14.5.1/img/champion/" + data.response3.championId + ".png";
            document.getElementById("champion1_name").innerText = data.response3.championId;
            document.getElementById("champion1_mastery").innerText = data.response3.championPoints;

            document.getElementById("champion2_icon").src = "https://ddragon.leagueoflegends.com/cdn/14.5.1/img/champion/" + data.response3.championId + ".png";
            document.getElementById("champion2_name").innerText = data.response3[1];

            document.getElementById("champion3_icon").src = "https://ddragon.leagueoflegends.com/cdn/14.5.1/img/champion/" + data.response3.championId + ".png";
